package pl.szataniol.utils.serialization 
{
	import flash.utils.describeType;

	/**
	 * @author Lukasz Witkowski, code@lukaszwitkowski.com, http://www.lukaszwitkowski.com
	 */
	public class AS3NotationSerializer 
	{
    	// TODO formatowanie, nowe linie itp
         ...
         */
        private static function escapeString( str:String, addQuotationMarks:Boolean = true):String {
        ...
        private static function objectToString( o:Object ):String
        {
            ...
            if ( classInfo.@name.toString() == "Object" )
            {
                    ...
                    for ( var key:String in o )
                    {
                            ...
                            s += escapeString(key, false) + ":" + serialize( value );
                    }
            }
